    ...
    <div class="min-h-screen">
        ...
        <section class="dark:bg-gray-900">
            <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
                ...
                <div class="lg:mt-0 lg:col-span-5 lg:flex">
                    <img src="{{ asset('storage/images/hero-docs.png') }}" alt="mockup">
                </div>
            </div>
        </section>
        ...
        <section class="bg-white dark:bg-gray-900">
            <div class="py-8 lg:py-8 mx-auto max-w-screen-xl px-4">
                <h2
                    class="mb-4 lg:mb-16 text-3xl font-extrabold tracking-tight leading-tight text-center text-gray-900 dark:text-white md:text-2xl">
                    “Piensa constantemente cómo podrías hacer mejor las cosas.” — Elon Musk</h2>
                <div
                    class="grid grid-cols-2 gap-8 text-gray-500 sm:gap-12 md:grid-cols-3 lg:grid-cols-6 dark:text-gray-400">
                    <a href="#" class="flex justify-center items-center img-home">
                        <img src="{{ asset('storage\images\AENICA.jpg') }}" alt="AENICA" class="w-24">
                    </a>
                    <a href="#" class="flex justify-center items-center img-home">
                        <img src="{{ asset('storage\images\CN.png') }}" alt="CN" class="w-24">
                    </a>
                    <a href="#" class="flex justify-center items-center img-home">
                        <img src="{{ asset('storage\images\DU.jpg') }}" alt="DU" class="w-24">
                    </a>
                    <a href="#" class="flex justify-center items-center img-home">
                        <img src="{{ asset('storage\images\NH-rif.png') }}" alt="NH-rif" class="w-24">
                    </a>
                    <a href="#" class="flex justify-center items-center img-home">
                        <img src="{{ asset('storage\images\TC.jpg') }}" alt="TC" class="w-24">
                    </a>
                    <a href="#" class="flex justify-center items-center img-home">
                        {{-- Otro logo --}}
                    </a>
